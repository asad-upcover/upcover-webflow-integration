(() => {
  ...
  null == s &&
    ...
    (t.parcelRequire94eb = s));
  var i = s.register;
  i("eEYVb", function (t, n) {
    e(t.exports, "AppBarWidget", () => r);
    var o = s("gJQzV"),
      i = s("b3sJF");
    class r {
      constructor(e = {}) {
        (this.tabs = e.tabs || [
          ...
          (this.themeManager = i.ThemeManager.getInstance()),
          e.themeColors && this.themeManager.setCustomColors(e.themeColors);
      }
      mount(e) {
      ...
      `),
        ...
        if (
          ((n.className = "tabs"),
          (n.innerHTML = this.tabs
            .map((e) => `<button data-tab="${e.id}">${e.label}</button>`)
            .join("")),
          n.querySelectorAll("button").forEach((e) => {
            e.addEventListener("click", () => {
              ...
              let t = e.dataset.tab;
              t && this.themeManager.setTheme(t),
        ...
        s.className = "contact-region-switcher";
        let i =
            localStorage.getItem("activeRegion") ||
            this.branding.contactRegion[0].code,
          r = () => {
            (s.innerHTML = ""),
              this.branding.contactRegion.forEach((e, t) => {
                let n = document.createElement("a");
                (n.href = e.url),
                  (n.textContent = e.label),
                  (n.style.fontWeight = i === e.code ? "900" : "600"),
                  n.addEventListener("click", (t) => {
                    localStorage.setItem("activeRegion", e.code),
                      (i = e.code),
                      r();
                  }),
                  s.appendChild(n),
                  t < this.branding.contactRegion.length - 1 &&
                    s.appendChild(document.createTextNode(" | "));
              });
          };
        r();
        let a = document.createElement("span");
        a.className = "contact-phone-container";
        let C = document.createElement("a");
        (C.href = `tel:${this.branding.contactPhone.replace(/\s+/g, "")}`),
          (C.innerHTML = this.branding.svg),
          (C.className = "contact-phone-svg");
        let l = document.createTextNode(this.branding.contactPhone);
        a.appendChild(C),
          a.appendChild(l),
          o.appendChild(s),
          o.appendChild(a),
    ...
    i("gJQzV", function (t, n) {
      e(t.exports, "callIcon", () => o),
        e(t.exports, "arrowDownIcon", () => s),
        e(t.exports, "upcoverLogoBusiness", () => i),
        e(t.exports, "upcoverLogoTech", () => r),
        e(t.exports, "upcoverLogoMotor", () => a);
      let o = `<svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
...
`;
    ...
    i("b3sJF", function (t, n) {
      e(t.exports, "ThemeManager", () => s);
      let o = { business: "#FF522D", tech: "#005DFF", motor: "#D5E525" };
      class s {
        constructor() {
        ...
        setCustomColors(e) {
          (this.customColors = { ...o, ...e }), this.notifyListeners();
        }
        getCurrentTheme() {
          return this.currentTheme;
        }
        getCurrentColor() {
          return (this.customColors || o)[this.currentTheme];
        }
        subscribe(e) {
          return (
  ...
  window.Upcover = {
    AppBarWidget: (e, t) => {
      ...
      n && new (0, r.AppBarWidget)(t).mount(n);
    },
  };
})();
