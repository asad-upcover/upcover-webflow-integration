...
`,document.head.appendChild(t);let n=document.createElement("div");if(n.className="tabs",n.innerHTML=this.tabs.map(e=>`<button data-tab="${e.id}">${e.label}</button>`).join(""),n.querySelectorAll("button").forEach(e=>{e.addEventListener("click",()=>{n.querySelectorAll("button").forEach(e=>e.classList.remove("active")),e.classList.add("active");let t=e.dataset.tab;t&&this.themeManager.setTheme(t),console.log("Tab clicked:",t)})}),this.tabs.length>0){let e=n.querySelector("button");e&&e.classList.add("active")}let o=document.createElement("div");o.className="contact";let r=document.createElement("span");r.className="contact-region-switcher";let i=localStorage.getItem("activeRegion")||this.branding.contactRegion[0].code,a=()=>{r.innerHTML="",this.branding.contactRegion.forEach((e,t)=>{let n=document.createElement("a");n.href=e.url,n.textContent=e.label,n.style.fontWeight=i===e.code?"900":"600",n.addEventListener("click",t=>{localStorage.setItem("activeRegion",e.code),i=e.code,a()}),r.appendChild(n),t<this.branding.contactRegion.length-1&&r.appendChild(document.createTextNode(" | "))})};a();let l=document.createElement("span");l.className="contact-phone-container";let s=document.createElement("a");s.href=`tel:${this.branding.contactPhone.replace(/\s+/g,"")}`,s.innerHTML=this.branding.svg,s.className="contact-phone-svg";let d=document.createTextNode(this.branding.contactPhone);l.appendChild(s),l.appendChild(d),o.appendChild(r),o.appendChild(l),e.appendChild(n),e.appendChild(o),document.body.insertBefore(e,document.body.firstChild)}}}),i("gJQzV",function(t,n){e(t.exports,"callIcon",()=>o),e(t.exports,"arrowDownIcon",()=>r),e(t.exports,"upcoverLogoBusiness",()=>i),e(t.exports,"upcoverLogoTech",()=>a),e(t.exports,"upcoverLogoMotor",()=>l);let o=`<svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
