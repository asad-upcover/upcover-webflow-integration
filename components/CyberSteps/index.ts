...
function injectStyles() {
  ...
  .cyber-steps-section .process-subtitle { font-size: 1.1rem; line-height: 1.6; opacity: 0.9; max-width: 600px; margin: 0 auto; }
  .cyber-steps-section .process-nav { display: flex; align-items: center; justify-content: center; gap: 12px; margin: 30px 0; }
  ...
  .cyber-steps-section .nav-tab { padding: 8px 16px; border-radius: 20px; background: rgba(255,255,255,0.9); color: #1e40af; font-weight: 600; font-size: 0.9rem; cursor: pointer; transition: all 0.3s ease; }
  ...
  .cyber-steps-section .process-steps { display: flex; gap: 24px; margin-bottom: 40px; overflow-x: auto; scroll-behavior: smooth; padding: 0 20px; }
  ...
  .cyber-steps-section .step-card { background: white; border-radius: 16px; padding: 32px 24px; text-align: left; box-shadow: 0 4px 20px rgba(0,0,0,0.1); transition: all 0.3s ease; min-width: 280px; flex-shrink: 0; color: #1f2937; }
  ...
  .cyber-steps-section .step-number { display: inline-flex; align-items: center; justify-content: center; width: 32px; height: 32px; background: #4285f4; color: white; border-radius: 50%; font-weight: 700; font-size: 1.1rem; margin-bottom: 20px; }
  .cyber-steps-section .step-title { font-size: 1.3rem; font-weight: 700; color: #1f2937; margin-bottom: 20px; }
  .cyber-steps-section .step-list { list-style: none; }
  .cyber-steps-section .step-item { display: flex; align-items: flex-start; gap: 12px; margin-bottom: 12px; color: #6b7280; line-height: 1.5; }
  .cyber-steps-section .step-item:last-child { margin-bottom: 0; }
  .cyber-steps-section .step-bullet { width: 6px; height: 6px; background: #4285f4; border-radius: 50%; margin-top: 8px; flex-shrink: 0; }
  .cyber-steps-section .cta-button { background: white; color: #4285f4; border: none; padding: 16px 32px; border-radius: 8px; font-size: 1rem; font-weight: 600; cursor: pointer; transition: all 0.3s ease; box-shadow: 0 2px 8px rgba(0,0,0,0.1); }
  ...
  @media (max-width: 768px) { .cyber-steps-section .process-title { font-size: 1.8rem; } .cyber-steps-section .process-subtitle { font-size: 1rem; } .cyber-steps-section .process-steps { grid-template-columns: 1fr; gap: 20px; } .cyber-steps-section .step-card { padding: 24px 20px; } }
  `;
